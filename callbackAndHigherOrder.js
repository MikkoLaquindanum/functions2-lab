...
const contains = (array, name, callback) => array.filter(element => {
  element === name ? callback(true) : callback(false)
});

// const contains = (array, name, callback) => array.forEach(element => {
//   element === name ? callback(true) : callback(false)
// });
...
const getUserById = (array, id, callback) => array.forEach(user => user.id === id ? callback(user) : 'Invalid' )
